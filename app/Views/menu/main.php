        ...
        <strong>Warning!</strong> <?= $msg1 ?>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="main" class="form-control" value="<?=set_value("main")?>">
          ...
          <tbody>
            ...
            if(!empty($result))
            {
                foreach ($result as $key => $val) {
                    ...
                    <tr>
                  <td><?= $key+1 ?></td>
                  <td><i class="fa <?=$val->icon?>"></i>&nbsp<?= $val->name ?></td>
                  <td><?= $val->orderlist ?></td>
                 
                  <td><?= $val->is_active == 'Y' ? 'Active' : 'Deactive' ?></td>
                    <td align="center"><a href="<?= base_url() ?>users/menu_edit/<?=$val->id?>"><span style="border-radius: 3px;" class="badge bg-yellow-gradient">&nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;</span></a></td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?=base_url()?>users/menudlt" id="form1" method="POST" enctype="multipart/form-data">
