...
if (!empty($msg1)) { ?>
    ...
    <div class="alert alert-warning alert-dismissible aap">
        ...
        <strong>Warning!</strong> <?= $msg1 ?>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <select class="form-control select2" name="main" id="main" >
                                       ...
                                       if(!empty($main))
                                       {
                                        ...
                                        {
                                            ?>
                                            <option <?=set_select("main",$val->id,$result[0]->main_id == $val->id ? true : false)?> value="<?=$val->id?>"><?=$val->name?></option>
                                            <?php
                                        }
                                       }
                                       ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="menuname" class="form-control" value="<?=!empty(set_value("menuname")) ? set_value("menuname") : $result[0]->name?>">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <input type="number" name="order" class="form-control" value="<?=!empty(set_value("order")) ? set_value("order") :   $result[0]->orderlist?>">
                                ...
                                <div class="col-md-4">
                                   ...
                                   <select class="form-control" name="status" >
                                    <option <?= set_select('status',"Y",$result[0]->is_active == 'Y' ? true : false) ?>  value="Y">Yes</option>
                                    <option <?= set_select('status',"N",$result[0]->is_active == 'N' ? true : false) ?> value="N">No</option>
    ...
    <script>
        ...
        function  getsub()
        {
            ...
            var postsub = "<?= $post['sub'] ?? $result[0]->sub_id ?>";
            let main = $('#main').val();
