                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Shipped List
                            </h3><br>
            ...
            <?php if (!empty($groupedOrders)): ?>
                <?php foreach ($groupedOrders as $order): ?>
                    ...
                    <tr>
                        ...
                        <td align="center"><a href="<?= base_url('adminvoice/'.$order['order_id'])?>" target="_blank">View Invoice</a></td>
                        <td><?= esc($order['track_id'] ?? '-') ?></td>
                        <td>
                            <?php if (!empty($order['track_url'])): ?>
                                <a href="<?= esc($order['track_url']) ?>" target="_blank">View Tracking</a>
                            <?php else: ?>
                                -
                            <?php endif; ?>
                        </td>
                        <td><strong><?= esc($order['created_date']) ?></strong></td>
                       <td align="center">
    <a href="<?= base_url('deliver/'.$order['order_id']) ?>" 
