...
<div id="myModal_cancel" class="modal fade" role="dialog">
  ...
  <!-- cancel MODAL end -->
   ...
   <div class="col-md-9 boxcol">
      ...
      <div class="">
      <h2 class="subhd hdng">Select Shipping Address</h2>   
                 <div class="col-sm-12">
          <?php
...
<div class="container-fluid cartitem cartbox<?= $a->id ?>">
    ...
    <div class="col-md-5 col-xs-8 details nopadcartr" style="margin-bottom: 20px;">  
        ...
        <span class="name">
            ...
            <?php if ($a->primary_address == 1): ?>
                <span style="color: #0c85ef; font-size: 10px;">This is your primary address</span>
            <?php endif; ?>
        </span>

        <div class="name">
            <?= $a->address ?><br>
            <?= $a->city_name ?>, <?= $a->state_name ?> - <?= $a->pincode ?><br>
            <?= $a->country_name ?>
        </div>

        <div class="name">Mobile: <?= $a->mobile ?></div>
        <div class="name">E-mail: <?= $customer_email ?? '' ?></div>

    </div><!-- col-md-5 -->


    <div class="col-md-4 col-xs-12 count mobcartaction nopadcartr">  
        <?php if ($a->primary_address == 1): ?>
            <span class="active text-center" style="color: #49ad18; font-size: 12px;">
                Primary <i class="fa fa-check"></i>
            </span>
        <?php else: ?>
       
       <span class="remove text-center"
      style="color: #ad1818; font-size: 12px; cursor:pointer;"
      onclick="window.location.href='<?= base_url('prime_add/' . $a->id) ?>'">
    Select <i class="fa fa-close"></i>
</span>
    ...
    <div class="col-md-3 col-xs-12 count mobcartaction nopadcartr">  
       <span class="upd text-center"
      onclick="window.location.href='<?= base_url('edit_address/' . $a->id) ?>'"
      style="color: #f8a50b; font-size: 12px; cursor:pointer;">
