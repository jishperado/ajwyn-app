...
<div id="myModal_cancel" class="modal fade" role="dialog">
  ...
  <!-- cancel MODAL end -->
    ...
    <div class="col-md-9 boxcol">
      <div class="">
      <h2 class="subhd hdng">Add new shipping addresses</h2>   
...
.rating > label:hover ~ label {
  color: #ffc107;
			    ...
			    <div class="container-fluid cartitem cartbox14972" style="margin-bottom: 10px;">
			      ...
			      <div class="col-md-12 col-xs-12 details nopadcartr" style="margin-bottom: 10px;">  
			        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <select class="form-control" id="country" onchange="get_state(this.value)" name="country">
                    ...
                    <option value="<?php echo $c->id ?>" <?php if($c->id == 101) echo 'selected' ?>><?php echo $c->name ?></option>
                    <?php } ?>
                   </select>
                </div>
...
<style>
  ...
  <!-----workspace end----->
<script>
function get_state(country_id, selectedState = null) {
    $.ajax({
        type: "POST",
        ...
        success: function(state) {
            ...
            // Load cities automatically based on selected state
            if (selectedState) {
                get_district(selectedState);
            }
        }
    });
}
...
$(document).ready(function(){
    let defaultCountry = 101;
    let defaultState   = 19;

    get_state(defaultCountry, defaultState); // This will also load cities of state 19
});
</script>
