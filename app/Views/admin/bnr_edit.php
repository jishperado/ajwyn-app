...
<div class="col-sm-4" >
                            ...
                            <div class="form-group">
                              <label style="font-weight:400;">Banner<br>Width : 2000px, Height : 550px, Format : jpg,jpeg,png
                            </label>
...
<div class="col-sm-4" >
                            ...
                            <div class="form-group">
                              <label style="font-weight:400;">Mobile Banner<br>Width : 1080px, Height : 1920px, Format : jpg,jpeg,png
                            </label>
                            <font size="2" color="red"> <?= $errors['mobile_photo'] ?? '' ?> </font> </div>

                            <div class="fileinput fileinput-new" data-provides="fileinput" style="margin-top:5px;" align="center">
                              <div class="fileinput-new thumbnail" style="width: 100px; height: 100px;" data-trigger="fileinput">
                              <?php

                                    $link = base_url() .  '/uploads/banner/' . $result[0]->mobile_banner;
                                ?>
                              <img src="<?= $link ?>">
                              </div>
                              <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px"></div>
      ...
      <div class="row">
          ...
          <div class="col-sm-12" align="left">
            <a href="<?= getenv('app_baseURL') ?>users/banner-list"><button type="button" class="btn btn-danger"> <i class="fa fa-arrow-left"></i> &nbsp;&nbsp;Cancel</button></a>
