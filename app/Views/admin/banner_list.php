        ...
        <table class="table table-bordered" width="100%" id="example1">
          <thead>
            <tr>
              ...
              <a href="<?= base_url('users/create-banner') ?>"><button class="badge bg-aqua-gradient" type="button" style=" border: 0px; font-weight: normal; border-radius: 3px; font-size:14px;" >&nbsp;&nbsp;Add New&nbsp;&nbsp;</button></a>
              </td>
            ...
            ?>
                <tr>
                  ...
                  <td><img src="<?= base_url() ?>uploads/banner/<?= $val->desk_banner ?>" width="80px"></td>
                    ...
                    <td align="center"><a href="<?= base_url() ?>users/bnr_edit/<?=$val->id?>"><span style="border-radius: 3px;" class="badge bg-yellow-gradient">&nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;</span></a></td>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?= base_url() ?>users/banner_dlt" id="form1" method="POST" enctype="multipart/form-data"><button type="submit" class="btn btn-danger" style="margin-right:0px;">&nbsp;&nbsp;Yes</button>
