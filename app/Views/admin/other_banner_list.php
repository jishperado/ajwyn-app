            ...
            ?>
                <tr>
                  ...
                  <td><img src="<?= base_url() ?>uploads/banner/<?= $val->desk_banner ?>" width="80px"></td>
                    ...
                    <td align="center"><a href="<?= base_url() ?>users/other_bnr_edit/<?=$val->id?>"><span style="border-radius: 3px;" class="badge bg-yellow-gradient">&nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;</span></a></td>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?= base_url() ?>users/otherbanner_dlt" id="form1" method="POST" enctype="multipart/form-data"><button type="submit" class="btn btn-danger" style="margin-right:0px;">&nbsp;&nbsp;Yes</button>
