                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Product
                              ...
                              <a href="<?= getenv('app_baseURL') ?>products/new" style="float:right">  <button type="button" class="btn btn-info">Create new product</button></a>
            ...
            if(!empty($result))
            {
                foreach ($result as $key => $val) {
                  ...
                  <td>
                    <?php
                    $vendorName = 'Admin';
                    if (!empty($val->vendor_id) && !empty($vendors)) {
                        foreach ($vendors as $v) {
                            if ($v->id == $val->vendor_id) {
                                $vendorName = $v->shop_name ?? $v->name;
                                break;
                            }
                        }
                    }
                  ...
                  <td><?= $val->orderlist ?></td>
                  <td align="center"><a href="<?= base_url('highlight/'.$val->id) ?>"><span style="border-radius: 3px;" class="badge bg-blue"><i class="fa fa-star"></i></span></a></td>
                  
                  <td align="center"><a href="<?= base_url('qa/'.$val->id) ?>"><span style="border-radius: 3px;" class="badge bg-blue">&nbsp;&nbsp;<i class="fa fa-question-circle"></i>&nbsp;&nbsp;</span></a></td>
                  <td align="center"><a href="<?= base_url('products/'.$val->id) ?>"><span style="border-radius: 3px;" class="badge bg-blue-gradient">&nbsp;&nbsp;<i class="fa fa-image"></i>&nbsp;&nbsp;</span></a></td>
                     
                    <td align="center"><a href="<?= base_url('products/edit/'.$val->id) ?>"><span style="border-radius: 3px;" class="badge bg-yellow-gradient">&nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;</span></a></td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?= base_url('users/productdelete') ?>" id="form1" method="POST" enctype="multipart/form-data">
                    <button type="submit"
