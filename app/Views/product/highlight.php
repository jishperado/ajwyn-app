                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Product Highlights
                            </h3><br>
...
<?php endif; ?>
        ...
        <?php if (empty($qa)): ?>
            <div class="qa-item row" style="margin-bottom:15px;">
                <div class="col-md-5">
                    <label>Label</label>
                    <textarea name="question[]" class="form-control" rows="3" placeholder="Enter label" required></textarea>
                </div>

                <div class="col-md-5">
                    <label>Value</label>
                    <textarea name="answer[]" class="form-control" rows="3" placeholder="Enter value" required></textarea>
                </div>
...
$(document).ready(function () {
    ...
    $(document).on("click", ".add-row", function () {
        ...
        <div class="qa-item row" style="margin-bottom:15px;">
            <div class="col-md-5">
                <textarea name="question[]" class="form-control" rows="3" placeholder="Enter Label" ></textarea>
            </div>

            <div class="col-md-5">
                <textarea name="answer[]" class="form-control" rows="3" placeholder="Enter Value" ></textarea>
            </div>
