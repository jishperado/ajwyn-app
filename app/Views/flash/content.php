...
if (!empty($msg1)) { ?>
    ...
    <div class="alert alert-warning alert-dismissible aap">
        ...
        <strong>Warning!</strong> <?= $msg1 ?>
                            ...
                            <!-- form start -->
                            <form action="<?=getenv('app_baseURL')?>content/update/<?=$result->id?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="message" class="form-control"><?=!empty(set_value("message")) ? set_value("message") : $result->content?></textarea>
                                ...
                                <div class="col-md-12" align="center">
                                   <br>
                                   <a href="<?=getenv('app_baseURL')?>content" class="btn btn-danger">Back</a>
