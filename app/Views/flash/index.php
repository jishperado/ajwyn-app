                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Content List
                            </h3><br>
          ...
          <tbody>
            ...
            if(!empty($result))
            {
                foreach ($result as $key => $val) {
                  ...
                  <td><?= $val->title ?></td>
                  <td><?= $val->content ?></td>
                  <td align="center"><a href="<?= ($val->id == 1) ? getenv('app_baseURL').'serve/show' : getenv('app_baseURL').'category/show/'.$val->id ?>"><span style="border-radius: 3px;" class="badge bg-blue">&nbsp;&nbsp;<i class="fa fa-eye"></i>&nbsp;&nbsp;</span></a></td>
             

                    <td align="center"><a href="<?= getenv('app_baseURL') ?>content/edit/<?=$val->id?>"><span style="border-radius: 3px;" class="badge bg-yellow-gradient">&nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;</span></a></td>
