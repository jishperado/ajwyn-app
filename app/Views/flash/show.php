          ...
          ?>
                  ...
                  <td>
                    <?php if (!empty($val->icon)) { ?>
                        <img src="<?= base_url() ?>web/images/<?=$val->icon?>" width="50" height="50">
                    <?php } ?>
                  </td>

                  <td align="center"><a href="<?= base_url() ?>serve/edit/<?= $val->id ?>"><span style="border-radius: 3px;" class="badge bg-yellow-gradient">&nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;</span></a></td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?= base_url() ?>flash/delete/1" id="form1" method="POST" enctype="multipart/form-data">
